...
Config.DisableAmbulanceStress = true -- If true will disable stress for people with the police job
Config.DisableFirefighterStress = true -- If true will disable stress for people with the police job
